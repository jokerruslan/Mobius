...
namespace Microsoft.Spark.CSharp.Proxy.Ipc
{
    ...
    internal class SparkContextIpcProxy : ISparkContextProxy
    {
        ...
        {
            return new SparkSessionIpcProxy(new JvmObjectReference((string)SparkCLRIpcProxy.JvmBridge.CallStaticJavaMethod("org.apache.spark.sql.api.csharp.SQLUtils", "createSparkSession", new object[] { jvmSparkContextReference })));
        }
